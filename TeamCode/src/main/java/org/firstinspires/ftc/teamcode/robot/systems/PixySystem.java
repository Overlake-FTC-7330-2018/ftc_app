...
public class PixySystem extends System
{
    ...
    public void getPixyValues()
    {
        if (teamColorIsBlue)
        {
            this.pixyCam = this.opMode.hardwareMap.get(PixyCam.class, "PixyCam1");
        }
        else
        {
            this.pixyCam = this.opMode.hardwareMap.get(PixyCam.class, "PixyCam2");
        }
        ...
        if (this.blueBlock.x != 0)
        {
            this.blueExists = true;
        }
        else
        {
            this.blueExists = false;
        }
        if (this.redBlock.x != 0)
        {
            this.redExists = true;
        }
        else
        {
            this.redExists = false;
        }
        if (this.otherThing.x != 0)
        {
    ...
    public void moveServos()
    {
        if (this.blueExists && this.redExists)
        {
            if (this.teamColorIsBlue)
            {
                ...
                {
                    this.horizServo.setPosition(this.HORIZ_CENTER + 0.2);
                }
                else
                {
        ...
        else if (this.blueExists && this.otherExists)
        {
            if (this.teamColorIsBlue)
            {
                if (this.otherThing.x < this.blueBlock.x)
                {
                    this.horizServo.setPosition(this.HORIZ_CENTER + 0.2);
                }
                else
            ...
            {
                if (this.blueBlock.x < this.otherThing.x)
                {
                    this.horizServo.setPosition(this.HORIZ_CENTER + 0.2);
                }
                else
        ...
        else if (this.otherExists && this.redExists)
        {
            if (this.teamColorIsBlue)
            {
                if (this.redBlock.x < this.otherThing.x)
                {
                    this.horizServo.setPosition(this.HORIZ_CENTER + 0.2);
                }
                else
